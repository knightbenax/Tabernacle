...
function register(){
  ...
  $sql = "INSERT INTO `cj2017_participants`(`Fullname`, `Phone`, `Email`, `Hear about Camp`, `Career`, `First time at Camp`, `Date Registered`, `Tribe`, `Gender`) VALUES (:fullname, :phone, :email, :hearaboutcamp, :career, :firsttime, CURRENT_TIMESTAMP, :tribe, :gender)";
