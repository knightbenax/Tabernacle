function showSocial(){
		if (!document.getElementById("backholder")) {
						...
						$("#dialogbody").html("<a href='https://twitter.com/intent/tweet?text=Get%20your%20own%20Camp%20Joseph%202016%20Avatar&url=http://campjoseph.herokuapp.org&via=officialydi' data-size='large'><i class='fa fa-3x fa-twitter-square'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='http://www.facebook.com/sharer/sharer.php?u=http://campjoseph.herokuapp.org/&title=Get%20your%20own%20Camp%20Joseph%202016%20Avatar' target='_blank' data-href='http://campjoseph.herokuapp.org/' data-layout='button_count'><i class='fa fa-3x fa-facebook-square'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='http://pinterest.com/pin/create/bookmarklet/?media=http://campjoseph.herokuapp.org/img/social_media-min.jpg&url=http://campjoseph.herokuapp.org/&is_video=false&description=Get%20your%20own%20Camp%20Joseph%202016%20Avatar' target='_blank'><i class='fa fa-3x fa-pinterest-square'></i></a><br/><br/><a href='javascript:void(0)' class='flat_button_green_white_outline closebutton'>Close</a>");
